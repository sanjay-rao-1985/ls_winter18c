- dashboard: ls_provider_int_app_sales_summary
  title: Sales Summary
  layout: grid
  rows:
...
#     listens_to_filters: []
  ...
  - name: data_table
    ...
    fields: [mn_pg_prod_hrc.product_name_num,
      mn_combined_sale_fact.inv_qty_12_months, mn_combined_sale_fact.inv_qty_prior_12_months,
      mn_combined_sale_fact.inv_qty_12_months_growth, mn_combined_sale_fact.inv_revenue_12_months,
      mn_combined_sale_fact.inv_revenue_prior_12_months, mn_combined_sale_fact.inv_revenue_12_months_growth]
    filters:
    ...
    sorts: [mn_combined_sale_fact.inv_revenue_12_months desc]
    limit: 100
    column_limit: 10
    total: true
  ...
  - name: sales_chart
    ...
    explore: provider_sales_ytd
    type: looker_column
    fields: [mn_pg_prod_hrc.product_name_num, mn_combined_sale_fact.rolling_12_months_year_label,
    ...
    listen:
      ...
      pwh_customer_name_num_flt: sl_parent_wholesaler.customer_name_num
      wh_customer_name_num_flt: sl_wholesaler.customer_name_num
    sorts: [mn_pg_prod_hrc.product_name_num, mn_combined_sale_fact.decimal_revenue desc
        0]
    limit: 100
    column_limit: 50
    total: true
    ...
    y_axes: [{label: Invoice Revenue, maxValue: !!null '', minValue: !!null '', orientation: left,
        showLabels: true, showValues: true, tickDensity: default, tickDensityCustom: 5,
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: 'Apollo
              [APOLLO]', name: 'Apollo [APOLLO]'}, {id: 'Casotrex [199993214]', name: 'Casotrex
              [199993214]'}, {id: 'Chemistry [CHEMASSAY]', name: 'Chemistry [CHEMASSAY]'},
          {id: 'Fostrex [199990232]', name: 'Fostrex [199990232]'}, {id: 'Galfen [199991166]',
            name: 'Galfen [199991166]'}, {id: 'Repritux [199993330]', name: 'Repritux
              [199993330]'}]}]
    x_axis_reversed: false
    show_dropoff: false
    y_axis_reversed: false
