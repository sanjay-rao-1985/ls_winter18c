- dashboard: ls_provider_int_app_gtn_trending
  title: Gross To Net Trending View
  layout: grid
  rows:
  - elements: [gtn_chart]
    height: 400
  ...
  - name: ytd_vs_year_selection_flt
    title: "YTD vs Full Year Selection"
    default_value: Full Year
    type: field_filter
    explore: provider_sales_ytd
    field:  mn_combined_sale_fact.ytd_vs_year_selection
    allow_multiple_values: false
    required: true
...
#     listens_to_filters: []
  ...
  elements:
  - name: gtn_table
    title: Top 10 Customer By Absolute Revenue Growth
    explore: provider_sales_ytd
    type: table
    fields: [sl_bill_to_customer.customer_name, sl_bill_to_customer.customer_num, mn_combined_sale_fact.net_revenue_toggle_year,
      mn_combined_sale_fact.net_revenue_toggle_prior_year, mn_combined_sale_fact.net_revenue_delta_year,
      mn_combined_sale_fact.net_revenue_growth_year, mn_combined_sale_fact.ytd_vs_year_label,
      mn_combined_sale_fact.inv_revenue_growth_year, mn_combined_sale_fact.adm_revenue_growth_year,
      mn_combined_sale_fact.rbt_fee_revenue_growth_year]
    pivots: [mn_combined_sale_fact.ytd_vs_year_label]
    filters:
    ...
    listen:
      ...
      ytd_vs_year_selection_flt: mn_combined_sale_fact.ytd_vs_year_selection
    ...
    sorts: [mn_combined_sale_fact.net_revenue_delta_year
        desc 0]
    limit: 10
    column_limit: 10
    total: true
  ...
  - name: gtn_chart
    title: Net Sales Performance
    explore: provider_sales_ytd
    type: looker_column
    fields: [mn_combined_sale_fact.ytd_vs_year_label, mn_combined_sale_fact.net_revenue_toggle_prior_year,
      mn_combined_sale_fact.inv_revenue_delta_year, mn_combined_sale_fact.adm_revenue_delta_year,
      mn_combined_sale_fact.rbt_fee_revenue_delta_year, mn_combined_sale_fact.net_revenue_toggle_year]
    filters:
      mn_combined_sale_fact.invoice_date:  36 months ago for 36 months
    listen:
      currency_mode_flt: mn_combined_sale_fact.base_local_curr_selection
      ...
      pwh_customer_name_num_flt: sl_parent_wholesaler.customer_name_num
      wh_customer_name_num_flt: sl_wholesaler.customer_name_num
    sorts: [mn_combined_sale_fact.ytd_vs_year_label 0]
    limit: 10
    column_limit: 10
    stacking: ''
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: left,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: mn_combined_sale_fact.net_revenue_toggle_prior_year,
            name: Prior Net Revenue}, {id: mn_combined_sale_fact.inv_revenue_delta_year,
            name: Invoice Revenue Growth}, {id: mn_combined_sale_fact.adm_revenue_delta_year,
            name: Admin Fee Growth}, {id: mn_combined_sale_fact.rbt_fee_revenue_delta_year,
            name: Rebates Growth}, {id: mn_combined_sale_fact.net_revenue_toggle_year,
