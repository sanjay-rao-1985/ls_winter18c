- dashboard: ls_provider_int_app_cmpl_cust_view
  title: Compliance Customer View
  layout: grid
  rows:
  - elements: [top_kpis]
    height: 130
  ...
  - name: data_table
    ...
    explore: mn_cmpl_period_fact
    type: table
    fields: [mn_contract_srep_dim.full_name, mn_customer_cmpl_dim.customer_name_num,
      mn_customer_cmpl_dim.org_id, mn_contract_header_dim.contract_name, mn_contract_header_dim.contract_number,
      mn_org_comb_product_group_dim.pg_name, mn_cmpl_period_fact.period_num, mn_cmpl_period_fact.period_start_date,
      mn_cmpl_period_fact.period_end_date, mn_cmpl_period_fact.period_status, mn_cmpl_period_fact.review_status_formatted,
      mn_cmpl_period_fact.commit_tier, mn_cmpl_period_fact.attained_tier, mn_cmpl_period_fact.expected_sales,
      mn_cmpl_period_fact.actual_sales, mn_cmpl_period_fact.revenue_loss, mn_cmpl_period_fact.revenue_over_to_date]
    filters:
    ...
    sorts: [ mn_customer_cmpl_dim.customer_name_num,mn_contract_header_dim.contract_number,  mn_org_comb_product_group_dim.pg_name, mn_cmpl_period_fact.period_start_date desc]
    limit: 500
    column_limit: 50
    dynamic_fields:
    ...
    series_labels:
      ...
      mn_cmpl_period_fact.cmpl_period_count: 'Total # of Customers'
      ...
      mn_cmpl_period_fact.period_num: Period Num
      mn_cmpl_period_fact.review_status_formatted: Review Status
      mn_cmpl_period_fact.expected_sales: Expected To Date
      mn_cmpl_period_fact.actual_sales: Actual To Date
    hidden_fields: [mn_cmpl_period_fact.review_status_out_of_compliance]


  - name: cmpl_stacked
    title: Overall Compliance (By Customer Count)
    explore: mn_cmpl_period_fact
    type: looker_column
    fields: [mn_cmpl_period_fact.date_period,
      mn_cmpl_period_fact.customer_count_compliant_count, mn_cmpl_period_fact.customer_count_out_of_compliance_count,
      mn_cmpl_period_fact.customer_count_over_compliant_count]
    filters:
      mn_cmpl_period_fact.period_start_date: before 0 minutes ago
    listen:
      currency_mode_flt: mn_cmpl_period_fact.base_local_curr_selection
    ...
    conditional_formatting_include_nulls: false
    series_labels:
      mn_cmpl_period_fact.customer_count_compliant_count: Compliant
      mn_cmpl_period_fact.customer_count_over_compliant_count: Over Compliant
      mn_cmpl_period_fact.customer_count_out_of_compliance_count: Out of compliance
    series_types:
      revenue_loss: line
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: left,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: mn_cmpl_period_fact.customer_count_compliant_count,
            name: Compliant, axisId: mn_cmpl_period_fact.customer_count_compliant_count},
          {id: mn_cmpl_period_fact.customer_count_over_compliant_count, name: Over Compliant,
            axisId: mn_cmpl_period_fact.customer_count_over_compliant_count}, {id: mn_cmpl_period_fact.customer_count_out_of_compliance_count,
            name: Out of compliance, axisId: mn_cmpl_period_fact.customer_count_out_of_compliance_count}]},
  ...
  - name: cmpl_rev_loss
    ...
    explore: mn_cmpl_period_fact
    type: looker_column
    fields: [mn_cmpl_period_fact.date_period, mn_cmpl_period_fact.customer_count_out_of_compliance_count,
    mn_cmpl_period_fact.revenue_loss, mn_customer_cmpl_dim.count]
    filters:
      mn_cmpl_period_fact.period_start_date: before 0 minutes ago
    listen:
      currency_mode_flt: mn_cmpl_period_fact.base_local_curr_selection
    ...
    - table_calculation: total_customers
      ...
      expression: "${mn_customer_cmpl_dim.count}"
      value_format:
      value_format_name:
      _kind_hint: measure
      _type_hint: number
    ...
    series_labels:
      mn_cmpl_period_fact.customer_count_out_of_compliance_count: "# Out of compliance"
      overall_compliance: Overall compliance
    hidden_fields: [mn_cmpl_period_fact.revenue_loss, mn_customer_cmpl_dim.count]
    series_types:
      revenue_loss: line
      mn_cmpl_period_fact.customer_count_out_of_compliance_count: scatter
    colors: ['palette: Santa Cruz']
    series_colors: {}
    reference_lines: []
    y_axes: [{label: Count, maxValue: !!null '', minValue: !!null '', orientation: left,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: total_customers,
            name: 'Total # of Customers', axisId: total_customers}, {id: mn_cmpl_period_fact.customer_count_out_of_compliance_count,
            name: "# Out of compliance", axisId: mn_cmpl_period_fact.customer_count_out_of_compliance_count}]}, {label: !!null '', maxValue: !!null '', minValue: !!null '',
        ...
        series: [{id: revenue_loss, name: Revenue Loss, axisId: revenue_loss}]}]
    hide_legend: false
    show_dropoff: false
  ...
  - name: top_kpis
    ...
    explore: mn_cmpl_period_fact
    type: table
    fields: [mn_customer_cmpl_dim.count_formatted, mn_cmpl_period_fact.expected_sales,
      mn_cmpl_period_fact.actual_sales, mn_cmpl_period_fact.customer_count_out_of_compliance_formatted,
      mn_cmpl_period_fact.revenue_loss_to_date_formatted, mn_cmpl_period_fact.customer_count_compliant_formatted,
      mn_cmpl_period_fact.customer_count_over_compliant_formatted, mn_cmpl_period_fact.revenue_over_to_date_formatted]
    filters:
      mn_cmpl_period_fact.period_start_date: before 0 minutes ago
    listen:
      currency_mode_flt: mn_cmpl_period_fact.base_local_curr_selection
    ...
    series_labels:
      mn_customer_cmpl_dim.count_formatted: Total Customers
      mn_cmpl_period_fact.customer_count_out_of_compliance_formatted: Under Compliant Count
      mn_cmpl_period_fact.revenue_loss_to_date_formatted: Under Compliant $
      mn_cmpl_period_fact.customer_count_compliant_formatted: Compliant Count
      mn_cmpl_period_fact.customer_count_over_compliant_formatted: Over Compliant Count
