- dashboard: sales_revenue_gross_to_net
  title: Sales Revenue Gross to Net
  layout: newspaper
  elements:
  - title: Revenue Gross To Net
    name: Revenue Gross To Net
    model: c_ls_provider_int_solutions_model_ls_winter18c
    explore: c_gross_to_net_sales
    type: looker_column
    fields:
    - mn_gross_to_net_label.kpi_name
    - mn_gross_to_net_label.kpi_num
    - mn_combined_sale_fact.list_revenue
    - mn_combined_sale_fact.oninvoice_total_rebate
    - mn_combined_sale_fact.invoice_revenue
    - mn_combined_sale_fact.total_ir_rebate
    ...
    - mn_combined_sale_fact.net_revenue
    - mn_combined_sale_fact.cogs_revenue
    - mn_combined_sale_fact.net_profit
    sorts:
    - mn_gross_to_net_label.kpi_num
    limit: 500
    column_limit: 50
    ...
    - label: ''
      ...
      - id: offset
        name: Offset
        __FILE: ls_winter17m/c_ls_revenue_waterfall.dashboard.lookml
        __LINE_NUM: 730
      - id: revenue
        name: Revenue
        __FILE: ls_winter17m/c_ls_revenue_waterfall.dashboard.lookml
        __LINE_NUM: 731
      - id: rebates_and_discounts
  ...
  - title: Customer Gross to Net Chart
    name: Customer Gross to Net Chart
    model: c_ls_provider_int_solutions_model_ls_winter18c
    explore: c_gross_to_net_sales
    type: table
    fields:
    - sl_sold_to_customer.customer_name_num
    - mn_combined_sale_fact.list_revenue
    - mn_combined_sale_fact.oninvoice_total_rebate
    - mn_combined_sale_fact.invoice_revenue
    - mn_combined_sale_fact.total_ir_rebate
    ...
    - mn_combined_sale_fact.net_profit
    sorts:
    - mn_combined_sale_fact.list_revenue desc
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: true
  ...
  - title: Top 10 Revenue Customers vs Discount
    name: Top 10 Revenue Customers vs Discount
    model: c_ls_provider_int_solutions_model_ls_winter18c
    explore: c_gross_to_net_sales
    type: looker_scatter
    fields:
    ...
    - mn_combined_sale_fact.list_revenue
    - mn_combined_sale_fact.oninvoice_total_rebate
    - mn_combined_sale_fact.oninvoice_percent_rebate
    - mn_combined_sale_fact.total_rbt_disc_percent_rebate
    - mn_combined_sale_fact.invoice_revenue
    sorts:
    - mn_combined_sale_fact.invoice_revenue desc
    limit: 10
    column_limit: 50
    total: true
    stacking: ''
    ...
    - label:
      ...
      valueFormat:
      series:
      - id: mn_combined_sale_fact.invoice_revenue
    ...
    - label:
      ...
      valueFormat:
      series:
      - id: mn_combined_sale_fact.total_rbt_disc_percent_rebate
        name: Total Rebates and Discount Percent (On and Off Invoice)
        __FILE: ls_winter17m/c_ls_revenue_waterfall.dashboard.lookml
        __LINE_NUM: 924
      - id: mn_combined_sale_fact.oninvoice_percent_rebate
  ...
  - title: Top 10 Customer % of Revenue
    name: Top 10 Customer % of Revenue
    model: c_ls_provider_int_solutions_model_ls_winter18c
    explore: c_gross_to_net_sales
    type: single_value
    fields:
  ...
  - title: Top 10 Customer Revenue Total
    name: Top 10 Customer Revenue Total
    model: c_ls_provider_int_solutions_model_ls_winter18c
    explore: c_gross_to_net_sales
    type: single_value
    fields:
  ...
  - title: Top 10 Weighted Avg Discount
    name: Top 10 Weighted Avg Discount
    model: c_ls_provider_int_solutions_model_ls_winter18c
    explore: c_gross_to_net_sales
    type: single_value
    fields:
