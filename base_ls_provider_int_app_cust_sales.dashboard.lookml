- dashboard: ls_provider_int_app_cust_sales
  title: Top Customers (Sales Growth By Customers)
  layout: grid
  rows:
  - elements: [top_chart]
    height: 400
  - elements: [bottom_chart]
    height: 400
  ...
  - name: kpi_selection_flt
    title: "Comparison KPI Selection"
    default_value: "Invoice Revenue"
    type: field_filter
    explore: provider_sales
    field:  mn_combined_sale_fact.kpi_selection
    allow_multiple_values: false
    required: true

  - name: gpo_idn_selection_flt
    title: "Customer Toggle"
    default_value: 'Bill-To'
    type: field_filter
    explore: provider_sales
    field:  mn_combined_sale_fact.gpo_idn_selection
    allow_multiple_values: false
    required: true
  ...
  - name: top_chart
    ...
    explore: provider_sales
    type: looker_column
    fields: [mn_combined_sale_fact.gpo_idn_cust_selection, mn_combined_sale_fact.invoice_year,
      mn_combined_sale_fact.growth_kpi_selection]
    pivots: [mn_combined_sale_fact.invoice_year]
    filters:
      sl_bill_to_customer.customer_name: "-NULL"
      mn_combined_sale_fact.growth_kpi_selection: NOT NULL
    listen:
      currency_mode_flt: mn_combined_sale_fact.base_local_curr_selection
      kpi_selection_flt: mn_combined_sale_fact.kpi_selection
      gpo_idn_selection_flt: mn_combined_sale_fact.gpo_idn_selection
    ...
    sorts: [ mn_combined_sale_fact.invoice_year, mn_combined_sale_fact.growth_kpi_selection desc 0]
    limit: 10
    column_limit: 50
    stacking: ''
    ...
    series_types: {}
    x_axis_label: Customer KPI
    y_axes: [{label: KPI, maxValue: !!null '', minValue: !!null '', orientation: left,
  ...
  - name: bottom_chart
    ...
    listen:
      ...
      pwh_customer_name_num_flt: sl_parent_wholesaler.customer_name_num
      wh_customer_name_num_flt: sl_wholesaler.customer_name_num
    sorts: [mn_combined_sale_fact.growth_kpi_selection asc 0, mn_combined_sale_fact.invoice_year]
    limit: 10
    column_limit: 50
    stacking: ''
    show_value_labels: false
