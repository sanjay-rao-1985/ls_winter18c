- dashboard: ls_provider_int_app_proposed_pricing
  title: Proposed Pricing Report
  layout: grid
  rows:
  ...
  - name: discount_percent_flt
    title: "Discount Percent (Do Not Change condition)"
    default_value: 5
    type: field_filter
    explore: provider_sales_and_contract_pricing
    field: mn_combined_sale_fact.discount_percent_flt
    required: true
    allow_multiple_values: false


  - name: whatif_mode_flt
    title: "Proposed Price Mode (Do Not Change condition)"
    default_value: 'Contract Price'
    type: field_filter
    explore: provider_sales_and_contract_pricing
    field: mn_combined_sale_fact.whatif_mode
    required: true
    allow_multiple_values: false
  ...
  - name: price_start_date_flt
    title: 'Contract Price Start Date'
    type: date_filter
    default_value: before now

  - name: price_end_date_flt
    title: 'Contract Price End Date'
    type: date_filter
    default_value: after now
  ...
  - name: price_table
    title: Proposed Pricing View
    explore: provider_sales_and_contract_pricing
    type: table
    fields: [mn_org_contract_header_dim.contract_name, mn_org_comb_product_group_dim.pg_name,
      mn_product_prc_dim.product_num, mn_product_prc_dim.product_name, mn_pg_product_fact.tier_idx,
      mn_pg_product_fact.product_base_price, mn_combined_sale_fact.avg_invoice_price,
      mn_combined_sale_fact.invoice_quantity, mn_combined_sale_fact.invoice_revenue,
      mn_pg_product_fact.product_price, mn_combined_sale_fact.max_discount_percent,
      mn_combined_sale_fact.whatif_mode_dim]
    filters:
    listen:
      currency_mode_flt: mn_combined_sale_fact.base_local_curr_selection
      discount_percent_flt: mn_combined_sale_fact.discount_percent_flt
      whatif_mode_flt:  mn_combined_sale_fact.whatif_mode
      ...
      price_start_date_flt:  mn_pg_product_fact.start_date
      price_end_date_flt: mn_pg_product_fact.end_date

    sorts: [mn_product_prc_dim.product_name, mn_pg_product_fact.tier_idx]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - table_calculation: proposed_price
      label: Proposed Price
      expression: if(${mn_combined_sale_fact.whatif_mode_dim} = "Contract Price", ${mn_pg_product_fact.product_price},
        ${mn_pg_product_fact.product_base_price}) * (1- ${mn_combined_sale_fact.max_discount_percent}/100)
      value_format:
      value_format_name: decimal_2
      _kind_hint: measure
      _type_hint: number
    - table_calculation: proposed_revenue
      label: Proposed Revenue
      expression: "${proposed_price} * ${mn_combined_sale_fact.invoice_quantity}"
      value_format:
      value_format_name: decimal_0
      _kind_hint: measure
      _type_hint: number
    - table_calculation: revenue_impact
      label: Revenue Impact
      expression: "${mn_combined_sale_fact.invoice_revenue} - ${proposed_revenue}"
      value_format:
      value_format_name: decimal_0
      _kind_hint: measure
      _type_hint: number
    - table_calculation: exposure
      label: "% Exposure"
      expression: "${revenue_impact}/${mn_combined_sale_fact.invoice_revenue}"
      value_format:
    ...
    hidden_fields: [mn_org_contract_header_dim.contract_name, mn_org_comb_product_group_dim.pg_name,
      mn_pg_product_fact.tier_idx, mn_combined_sale_fact.max_discount_percent, mn_combined_sale_fact.whatif_mode_dim]
    series_labels:
      ...
      mn_pg_product_fact.product_base_price: Contract List (Base) Price
